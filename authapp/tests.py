...
class TestUserManagement(TestCase):
    def setUp(self):
        ...
        self.client = Client()
        self.superuser = ShopUser.objects. \
            create_superuser('django2',
                             'django2@geekshop.local', 'geekbrains')
        self.user = ShopUser.objects. \
            create_user('tarantino',
                        'tarantino@geekshop.local', 'geekbrains')
        self.user_with__first_name = ShopUser.objects. \
            create_user('umaturman',
